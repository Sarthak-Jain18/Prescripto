...
export default function RelatedDoctors({ docId, speciality }) {
    ...
    return (
        <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
            ...
            <div className="w-full grid grid-cols-[repeat(auto-fit,minmax(200px,200px))] gap-4 pt-5 gap-y-6 px-3 sm:px-0">
            ...
            <button onClick={() => { navigate('/doctors'); scrollTo(0, 0) }}
                className="bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 cursor-pointer hover:scale-105 transition-all">
                more
            </button>
