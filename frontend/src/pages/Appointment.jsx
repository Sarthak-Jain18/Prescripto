    ...
    async function getAvailableSlots() {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            while (currentDate < endTime) {
                ...
                // don't show already booked slot 
                if (isSlotAvailable) {
                    timeSlots.push({
        ...
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 -mt-20 sm:mt-0'>
                    ...
                    <div>
                        <p className='flex items-center gap-1 text-lg font-medium text-gray-900 mt-3'>About <img src={assets.info_icon} alt="" className='w-5 p-0.5' /></p>
