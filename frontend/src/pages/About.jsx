        ...
        <div>
            ...
            <div className='flex flex-col md:flex-row my-10 gap-12'>
                ...
                <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
                    <p>Welcome to Prescripto, your trusted partner in managing your healthcare needs conveniently
                    ...
                    <p>
                        ...
                        to bridge the gap between patients and healthcare providers, making it easier for you to access
